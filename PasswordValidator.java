...
public class PasswordValidator {
    public static void main(String[] args) {
        ...
        if (passLenghtValidation(password) && isConsistOnlyLetters(password) &&
        ...
        if (!isConsistOnlyLetters(password)) {
    ...
    private static boolean passLenghtValidation(String password) {
        return password.length() >= 6 && password.length() <= 10;
    }

    private static boolean isConsistOnlyLetters(String password) {
